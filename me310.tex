...
\begin{example} A mixed-mode solar dryer design with aluminum columns and beams. \cite{akamphon2018integrated} 
  ...
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}
      \node [draw, minimum height=3mm, minimum width=3cm, rotate=15, fill=LightSkyBlue](heater){};
      \node at (heater.south east) [anchor=south west, draw, minimum height=6mm, minimum width=3cm, rotate=15, fill=LightSkyBlue](dryer){};
      \node at (heater.south west) [anchor=north west, draw, minimum height=1cm, minimum width=2mm, fill=LightGrey](lleg){};
      \node at (dryer.south east) [anchor=north east, draw, minimum height=2cm, minimum width=2mm, fill=LightGrey](lleg){};
    \end{tikzpicture}
