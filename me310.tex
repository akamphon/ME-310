...
For simple geometric cross sections, $J$ may be evaluated analytically, as shown in ...

\begin{example} Polar moment of inertia of a circular cross section shaft.
  ...
  In a circle, it is much simpler to integrate in polar coordinates. In that case $dA = r dr d\theta$
