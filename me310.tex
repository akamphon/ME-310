...
\DeclareDocumentCommand{\pynum}{ m }{
  \py{'\\num{'+str('{:.2e}'.format(#1))+'}'}
}
...
In this textbook, students will be introduced to engineering design process and fundamental decisions that are involved.  Basic review of engineering materials and its application in mechanical design is the next topic, with additional focus on material selection.
...
\begin{table}[h]
  ...
  \begin{tabular}{clp{8cm}}
    ...
    0.15 & Mild steel & Case carburizing quality \\
    ...
    0.4 - 0.5 & Medium carbon steel & Shafts, gears, railway tires \\
...
Addition of alloying elements to steel is done to increase strength or hardenability, or achieving a special properties such as corrosion resistance or extreme temperature stability.
...
\begin{enumerate}
\item Austenitic stainless steel: The largest family of them all. They possess an austenitic microstructure, achieved by alloying with sufficient nickel and manganese and nitrogen to main tain the microstructure at all temperatures, thus making them unhardenable by heat treatment. They have relatively low yield strength but high elongation, and are weldable by all processes.
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \node(A){\large C};
    \draw [double, double distance=1mm, very thick] (A) --++ (0:0.75) node[right](B){\large C};
    \draw [very thick] (B) --++ (90:0.75) node[above]{\large F};
    \draw [very thick] (B) --++ (-90:0.75) node[below]{\large F};
    \draw [very thick] (A) --++ (90:0.75) node[above]{\large F};
    \draw [very thick] (A) --++ (-90:0.75) node[below]{\large F};

    \draw [->, very thick] (B.east) ++ (0:0.2) --++ (0:1) node(C){};

    \draw [very thick] (C) --++ (0:0.75) node[right](D){\large C};
    \draw [very thick] (D) --++ (0:0.75) node[right](E){\large C};
    \draw [very thick] (E) --++ (0:0.75);
    \draw [very thick] (D) --++ (90:0.75) node[above]{\large F};
    \draw [very thick] (D) --++ (-90:0.75) node[below]{\large F};
    \draw [very thick] (E) --++ (90:0.75) node[above]{\large F};
    \draw [very thick] (E) --++ (-90:0.75) node[below]{\large F};

    \node at (C.south) [yshift=-1.5cm]{tetrafluoroethene $\rightarrow$ poly(tetrafluoroethene)};
  \end{tikzpicture}
  \hspace{5mm}
  \begin{tikzpicture}
    \node(A){\large C};
    \draw [double, double distance=1mm, very thick] (A) --++ (0:0.75) node[right](B){\large C};
    \draw [very thick] (A) --++ (90:0.75) node[above]{\large H};
    \draw [very thick] (A) --++ (-90:0.75) node[below]{\large H};
    \draw [very thick] (B) --++ (90:0.75) node[above]{\large Cl};
    \draw [very thick] (B) --++ (-90:0.75) node[below]{\large H};
    ...
    \draw [very thick] (D) --++ (90:0.75) node[above]{\large F};
    \draw [very thick] (D) --++ (-90:0.75) node[below]{\large F};
    \draw [very thick] (E) --++ (90:0.75) node[above]{\large Cl};
    \draw [very thick] (E) --++ (-90:0.75) node[below]{\large F};

    \node at (C.south) [yshift=-1.5cm]{vinyl chloride $\rightarrow$ poly(vinyl chloride)};
  \end{tikzpicture} \\
  \begin{tikzpicture}
    \node(A){\large C};
    \draw [double, double distance=1mm, very thick] (A) --++ (0:0.75) node[right](B){\large C};
    \draw [very thick] (A) --++ (90:0.75) node[above]{\large H};
    \draw [very thick] (A) --++ (-90:0.75) node[below]{\large H};
    \draw [very thick] (B) --++ (90:0.75) node[above]{\large CH$_3$};
    \draw [very thick] (B) --++ (-90:0.75) node[below]{\large H};
    ...
    \draw [very thick] (D) --++ (90:0.75) node[above]{\large F};
    \draw [very thick] (D) --++ (-90:0.75) node[below]{\large F};
    \draw [very thick] (E) --++ (90:0.75) node[above]{\large CH$_3$};
    \draw [very thick] (E) --++ (-90:0.75) node[below]{\large F};

    \node at (C.south) [yshift=-1.5cm]{propene $\rightarrow$ poly(propene)};
  \end{tikzpicture}
  \hspace{10mm}
  \begin{tikzpicture}
    \node(A){\large C};
    ...
    \draw [very thick] (A) --++ (90:0.75) node[above]{\large H};
    \draw [very thick] (A) --++ (-90:0.75) node[below]{\large H};
    \draw [very thick] (B) --++ (90:0.75) node[above]{\large C$_6$H$_5$};
    \draw [very thick] (B) --++ (-90:0.75) node[below]{\large H};
    ...
    \draw [very thick] (D) --++ (90:0.75) node[above]{\large F};
    \draw [very thick] (D) --++ (-90:0.75) node[below]{\large F};
    \draw [very thick] (E) --++ (90:0.75) node[above]{\large C$_6$H$_5$};
    \draw [very thick] (E) --++ (-90:0.75) node[below]{\large F};

    \node at (C.south) [yshift=-1.5cm]{styrene $\rightarrow$ poly(styrene)};
  \end{tikzpicture} \\
...
\begin{solution}
  ...
  In order to save on cost, it is a good idea to use used empty bottles rather than make new bottles. That should eliminate the cost consideration. However, if in certain areas, these empty bottles have significantly values or are difficult to obtain, we should revisit the cost of making new bottles. Going through the rest of the list, and looking at available mass produced beverage bottles, our options are 
...
\item Kevlar fiber: This is an aramid fiber, yellowish in color. These are aromatic polyamides obtained by synthesis at $-10^{\circ}$C, then fibrillated and drawn to obtain high modulus of elasticity.
\item Carbon fiber: filaments of polyacrilonitrile or pitch are oxidized at $T > 300^{\circ}$C, then heated further to $1500^{\circ}$C in a nitrogen atmosphere. Then only the hexagonal carbon chains remain. High modulus of elasticity is obtained by drawing at high temperature.
\item Boron fiber: tungsten filament serves to catalyze the reaction between boron chloride and hydrogen at 1200$^{\circ}$C. The boron fiber obtained have a diameter of about 100 $\mu$m.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis} [
      ...
      \addplot+[mark=none]{(1-x) +2*x} node[midway, above left]{Upper};
      \addplot+[mark=none]{2/(x + 2*(1-x))} node[midway, below right]{Lower};
    \end{axis}
  \end{tikzpicture}
...
\item Composite materials have medium to low level impact resistance, inferior to that of metallic materials.
\item Composite materials have excellent fire resistance as compared with the light alloys with identical thicknesses. However, smokes from the combustion of certain matrices can be toxic.
\end{itemize}
...
In many design problems, the objectives are coupled to the constrains of the components. For example, if we are to design a light bar that would be under tension, the constraint on the component would be that its stress cannot be more than its yield strength (given that the material is ductile), which involve its cross-sectional area. However, the mass of the bar would also be dependent on its volume and, obviously, its cross-sectional area. There must be a way for us to determine the essential parameters that will help determine that optimal material for a component, right?
...
\begin{solution}
  ...
  According to \cref{fig: turbine shaft example strength-temp diagram}, we can draw a vertical line at 300 C. Materials that fall to the left side do not qualify as they do not possess sufficient strength above 300 C. That means engineering composites, plastics, foams, along with aluminum, zinc, and magnesium alloys do not pass this requirement.
  
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}[>=latex]
      \node(A){\includegraphics[width=0.9\textwidth]{pictures/Material-selection/strength-temperature-diagram}};
      \draw [dashed, red] (A.south) ++ (180:0.35) --++ (90:13.5) node[midway, left, red]{300 C};
      \node at (A.north east) [xshift=-4cm, yshift=-4cm, circle, draw, red, minimum height=6cm](C){};
    ...
    \label{fig: turbine shaft example strength-temp diagram}
  \end{figure} 
...
\begin{equation}
  ...
  \begin{array}{c}
    \sigma _x(\Delta y\Delta z) + \sigma_x^{\prime}(\Delta y\Delta z) = 0\\
    \sigma _x =  - \sigma_x^{\prime}
  \end{array}
\end{equation}

We can similarly prove that $\sigma_y = \sigma_{y^{\prime}}$ and $\sigma_z = \sigma_{z^{\prime}}$. Therefore, for a constant state of stress, each of the three normal stress components must be equal in magnitude but opposite in direction.
...
\begin{equation}
  \varepsilon _{avg} = \frac{s^{\prime} - s}{s}
\end{equation}
...
\begin{example}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      \node at (beam.west) [anchor=east, fill=LightGrey, pattern=north west lines, minimum height=2cm, minimum width=5mm](left){};
      \draw (left.north east) -- (left.south east);
      \node at (beam.east) [anchor=west, fill=LightGrey, pattern=north west lines, minimum height=2cm, minimum width=5mm](right){};
      \draw (right.north west) -- (right.south west);
...
\begin{figure}[h]
  ...
  \end{tikzpicture}
  \caption[Moment-curvature formula derivation illustration]{Infinitesimal bending moment $dM$ generated from force $\sigma dA$ with a distance $y$ from the neutral axis.}
\end{figure}
...
\begin{solution}
  ...
  We can use a continuous boundary condition at $x = L/2$ to solve for $C_1$ once we have obtained the functional form of the deflection curve for $x \geqslant L/2$. Preferably, we can also solve for $C_1$ by applying symmetry condition. In other words, we know that the problem is symmetric about the axis $x = L/2$, and thus the slope of the beam in the middle \emph{must} be zero. This way, we do not need to know the functional form of the right half of the deflection curve.
...
When the rest of the loads are applied, they produce the same displacement as before and do the same amount of work as before. However, during the application of these loads, the force $dP_i$ automatically moves through the displacement $\delta_i$. It therefore produces additional work equal to the product of the force and the distance (without the 1/2 factor since the full load acts throughout the displacement). Thus, the final strain energy for the second loading sequence is

\[\frac{dP_id\delta _i}{2} + U + dP_i\delta _i\]

But this quantity is the same as the strain energy from the first loading sequence, namely when the load $dP_i$ is applied last, so that
...
\[ \begin{gathered}
  ...
  \begin{split}
    \sigma_{x^{\prime}}\Delta A - (\tau_{xy}\Delta A\sin \theta )\cos \theta  &- (\sigma_y\Delta A\sin \theta )\sin \theta  \\
...
\[\begin{gathered}
  \sigma_{x^{\prime}} = \sigma_x\cos^2\theta  + \sigma_y\sin^2\theta  + 2\tau_{xy}\sin \theta \cos \theta  \hfill \\
  \sigma _{x^{\prime}} = \frac{\sigma_x}{2}(1 + \cos 2\theta ) + \frac{\sigma_y}{2}(1 - \cos 2\theta ) + {\tau_{xy}}\sin 2\theta  \hfill \\
  \sigma_{x^{\prime}} - \left( \frac{\sigma_x + \sigma_y}{2} \right) = \left( \frac{\sigma_x + \sigma_y}{2} \right)\cos 2\theta  + {\tau_{xy}}\sin 2\theta  \hfill \\
\end{gathered} \]

\[\begin{gathered}
  \tau_{x^{\prime}y^{\prime}} = (\sigma_y - \sigma_x)\sin \theta \cos \theta  + \tau_{xy}(\cos^2\theta  - \sin^2\theta ) \\
  \tau_{x^{\prime}y^{\prime}} = \left( \frac{\sigma_y - \sigma_x}{2} \right)\sin 2\theta  + \tau _{xy}\cos 2\theta \hfill \\
\end{gathered} \]

Square both expressions and add them together, we have

\[\begin{gathered}
    \left[ \sigma_{x^{\prime}} - \left( \frac{\sigma_x + \sigma_y}{2} \right) \right]^2 + \tau_{x^{\prime}y^{\prime}}^2 = \left( \frac{\sigma_x - \sigma_y}{2} \right)^2\cos^2 2\theta  + 2\left( \frac{\sigma_x - \sigma_y}{2} \right)\tau_{xy}\cos 2\theta \sin 2\theta  + \tau_{xy}^2\sin^2 2\theta \\
...
\begin{solution}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      \begin{axis} [
        ...
        \addplot+[mark=none]{-30*(cos(x))^2 + 20*(sin(x))^2 + 50*sin(x)*cos(x)} node[right]{$\sigma_{x^{\prime}}$};
  ...
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}
      \node at (-3,0) [anchor=west, draw, fill=SkyBlue, circle, minimum height=5cm](large){};
      \draw [<->] (-5,0) --++ (0:8) node[right]{$\sigma$};
      ...
      \draw (large.center) --++ (-45:2.5) node(A){};
      \draw [dashed] (A.center) --++ (90:1.75) node[above]{20};
      \draw (large.center) --++ (135:2.5) node(B){};
      \draw [dashed] (B.center) --++ (0:2.2) node[right]{25};
      \draw [dashed] (B.center) --++ (-90:1.7) node[below]{-30};
    \end{tikzpicture}
  \end{figure}
\end{solution}
...
\begin{example} Analysis of De Havilland Comet Accident
  ...
  \begin{figure}[H]
    ...
    \caption*{Location of and loads applied at the fatigue cracking of the De Havilland Comet. \cite{swift1987damage,wanhill2015milestone}} 
  \end{figure}
...
\begin{figure}[h]
  \centering 
  \begin{tikzpicture}
    \node [anchor=west, draw, fill=SkyBlue, circle, minimum height=7cm](large){};
    \draw [<->] (-2,0) --++ (0:10) node[right]{$\sigma$};
    \draw [<->] (0,-5) --++ (90:10) node[above]{$\tau$};
    \node at (large.east) [below right] {$\sigma_1 = S_y$};
    \draw (0,0) node[below left]{0};
    \draw [dashed](large.center) -- (large.north) node[above right](absolute){$\tau_{\max} = \dfrac{S_y}{2}$};
  \end{tikzpicture}
...
\begin{example} Failure of a ductile element under MSST
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[>=latex]
      \node [draw, fill=LightBlue, regular polygon, regular polygon sides=4, minimum width=2cm](A){};
      \draw [->,very thick] (A.north) --++ (90:1) node[above]{$\sigma_y = 70$ MPa};
      \draw [<-,very thick] (A.east) --++ (0:1) node[right]{$\sigma_x = -80$ MPa};
      \draw [<-,very thick] (A.west) --++ (180:1);
      \draw [->,very thick] (A.south) --++ (-90:1);
      \node at (A.north west) [yshift=2mm] (B){};
      \draw [-left to, very thick] (B) --++ (0:1.3);
...
\begin{solution}
  ...
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}
      \draw [fill=lightblue] (0,-3) node[right]{$-120$} -- (3,0) node[below right]{$120$} -- (3,3) -- (0,3) node[left]{$120$} -- (-3,0) node[above left]{$-120$} -- (-3,-3) -- cycle;
      \draw [<->] (-4,0) --++ (0:8) node[right]{$\sigma_1$};
      \draw [<->] (0,-4) --++ (90:8) node[above]{$\sigma_2$};
      \node at (-3.3, 2.8) [fill=Black, draw, minimum height=1mm, minimum width=1mm, inner sep=0](state){};
      \node at (state) [below right]{(-135, 115)};
    \end{tikzpicture}
  \end{figure}
\end{solution}
...
\begin{solution}
  ...
  Now we need to determine the change in temperature that will lead to that critical load. Let points A and B be the two ends of the rail. Following steps to solve a statically indeterminate problem (equilibrium equation, compatibility equation, and Hooke's law), we can write that:
...
\begin{solution}
  ...
  The maximum bending moment, according to $M(x)$ is at $x$ = 0.5 where $M$ = $3(2000)(0.5)/4$ = \py{round(3*2000*0.5/4)} N-m. Since we have assumed that the material is ductile, we will employ MDET \cref{eqn: design eqn for MDET} and bending stress \cref{eqn: flexure formula} for our design equation, which gives
...
\begin{example} A 1-m long shaft is fitted with a pulley and timing belt. The tensions on the slack and tight sides are 2000 N and 500 N respectively. The pulley radius is 5 cm. Size the proper shaft size so that it has a safety factor of 2.5. The shaft is made of AISI1023 with $S_y$ = 400 MPa.
...
\begin{example} A mixed-mode solar dryer design with aluminum columns and beams. \cite{akamphon2018integrated} 
  ...
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}
      \node [minimum height=3mm, minimum width=3cm, rotate=15, fill=LightSkyBlue](heater){\scriptsize air heater};
      \node at (heater.south east) [anchor=south west, minimum height=6mm, minimum width=3cm, rotate=15, fill=LightSkyBlue](dryer){dryer};
      \draw (heater.south west) -- (heater.north west) -- (heater.north east) -- (dryer.north west) -- (dryer.north east) -- (dryer.south east) -- cycle;
      \node at (heater.south west) [anchor=north west, draw, minimum height=2mm, minimum width=6cm, rotate=15, fill=LightGrey](beam){};
      \node at (heater.south west) [anchor=north west, draw, minimum height=1cm, minimum width=2mm, fill=LightGrey](lleg){};
      \node at (dryer.south east) [anchor=north east, draw, minimum height=2.6cm, minimum width=2mm, fill=LightGrey](rleg){};
      \draw [->, ultra thick] (heater.south) --++ (-90:0.5) node[below]{10 kg};
      \draw [->, ultra thick] (dryer.south) --++ (-90:1) node[below]{30 kg};
    \end{tikzpicture}
    \caption{Schematic drawing of the designed solar dryer}
    \label{fig: solar dryer}
  \end{figure}

  The air heater does not have a product inside, obviously, just a black aluminum plate. The air heater is otherwise a transparent acrylic box, and the same goes for the dryer. The air heater weighs 10 kg. The dryer, slightly larger than the air heater, weighs 30 kg, including the products. Design the supporting beams and the legs.
\end{example}
\begin{solution}
  ...
  The support forces in the left and right columns are \py{int(F_l)} and \py{int(F_r)}, respectively. Now, considering the beam first, We can determine the distribution of bending moment along the length of the beam. Taking $x = 0$ from the left column, the bending moment is
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot [domain=0:0.25, DarkBlue]{150*x*cos(15)};
        \addplot [domain=0.25:0.75, DarkRed]{150*x*cos(15) - 100*(x-0.25)*cos(15)};
        \addplot [domain=0.75:1, DarkGrey!20!Black] {250*(1-x)*cos(15)};
      \end{axis}
    \end{tikzpicture}
  \end{figure}
...
\begin{exercises}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      \node at (A.south) [anchor=north, rectangle, pattern=north east lines, minimum height=1cm, minimum width=2cm](ground){};
...
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
    \node [pattern=north west lines, minimum height=1cm, minimum width=10cm](ground){};
    \draw (ground.north west) -- (ground.north east);
    \draw [double=Grey, double distance=1pt, decoration={aspect=0.2, segment length=0.3cm, amplitude=0.4cm,coil},decorate, line width=1pt] (ground.north west) ++ (0:1) --++ (90:2.72) node(left){};
    \draw [|<->|] (left.center) ++ (0:0.6) ++ (-90:0.3) --++ (-90:0.3) node[midway, right]{$p$};
    \draw [double=Grey, double distance=1pt, decoration={aspect=0.15, segment length=0.2cm, amplitude=0.4cm,coil},decorate, line width=1pt] (ground.north) --++ (90:1.63) node(mid){};
    \draw [<-, ultra thick] (mid.center) --++ (90:0.5) node[above]{$F$};
    \draw [double=Grey, double distance=1pt, decoration={aspect=0.1, segment length=0.1cm, amplitude=0.4cm,coil},decorate, line width=1pt] (ground.north east) ++ (180:1) --++ (90:0.74) node(right){};
    \draw [<-, ultra thick] (right.center) --++ (90:0.5) node[above]{$F_s$};
    \draw [|<->|] (ground.north west) ++ (0:0.1) --++ (90:2.72) node[midway, fill=White]{$L_f$};
    \draw [|<->|] (ground.north) ++ (0:3) --++ (90:0.74) node[midway, fill=White]{$L_s$};
  \end{tikzpicture}
  \caption{Length and geometry of helical compression springs}
  \label{fig: com helical spring geometry}
\end{figure}

\begin{align}
  L_f - L_s = N_a g
\end{align}
where $N_a$ is the number of gaps and is equal to the number of active coils, number of coils that actually contributes to the compression of the spring. The gap between each coil is equal to the distance between adjacent coils, also called the pitch $p$, subtracted by the diameter of the spring wire, $d$. The previous equation for range can be written again as

\begin{align}
  L_f - L_s = N_a (p - d)
\end{align}

At each end of a compression spring, external force $F$ is applied along the axis of the helix. This is achieved by winding the end coils with zero pitch and grinding the ends flat to insure uniformly distributed load at end plates. In the tension spring, the end hooks are formed to position the load along the axis.
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \node at (2) [yshift=-1.5cm, draw, rectangle, fill=LightSkyBlue, minimum height=1cm, minimum width=2cm, text width=2cm, align=center](3){Stiffness \\ $N_a$};
    ...
    \draw [->] (6.east) --++ (0:1.575) node[midway, above]{Yes} --++ (90:9) -- (1);
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      xlabel={Fatigue Life (cycles)},
      ylabel={$\dfrac{\tau_a}{S_{ut}}$},
      grid=both,
      ]
      \addplot+ [SkyBlue, ultra thick, domain=1000:1000000, mark=none, thick] {x^(-1/7.58)*10^(3/7.58)*0.72};
      \addplot+ [SkyBlue, ultra thick, domain=1000000:10000000, mark=none, thick] {0.29};
    \end{axis}
  \end{tikzpicture}
  \caption{Estimated $S-N$ curve for round steel spring wire under torsional loading}
  \label{fig: s-n curve for steel spring wire}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture} 
    \begin{axis}[
      ...
      \addplot [SkyBlue, ultra thick] {-0.72/0.8*x + 0.72} node[at start, pin={[pin edge={latex-, Black}, pin distance=0.5cm, text=Black]0:0.72}]{};
      \addplot [SkyBlue, ultra thick] {-0.54/0.8*x + 0.54} node[at start, pin={[pin edge={latex-, Black}, pin distance=0.5cm, text=Black]0:0.54}]{};
      \addplot [SkyBlue, ultra thick] {-0.395/0.8*x + 0.395} node[at start, pin={[pin edge={latex-, Black}, pin distance=0.5cm, text=Black]0:0.395}]{};
      \addplot [SkyBlue, ultra thick] {-0.29/0.8*x + 0.29} node[at start, pin={[pin edge={latex-, Black}, pin distance=0.5cm, text=Black]0:0.29}]{};
      \addplot+ [domain=0:0.5, dashdotted, thick, Black] {x};
    \end{axis}
    % tau_m = 0
    \begin{axis}[
      width=0.2\textwidth,
      ...
      \addplot+ [domain=0:3, very thick, SkyBlue] {sin(300*x)};
      \node [below right] {$\tau_m$ = 0};
    \end{axis}
    \draw [-latex] (0.1\textwidth,0.4\textwidth) ++ (-0.6,0.6) --++ (-170:1);
    % tau_a / tau_m = 1
    \begin{axis}[
      width=0.2\textwidth,
      height=0.15\textwidth,
      ...
      \addplot+ [domain=0:3, very thick, SkyBlue] {sin(300*x)+1};
      \addplot+ [domain=0:3, Black, dashed] {1};
      \node [below right, yshift=-0.1cm] {$\dfrac{\tau_a}{\tau_m} = 1$};
    \end{axis}
    \draw [-latex] (0.3\textwidth,0.35\textwidth) ++ (-0.2,-0.2) --++ (-100:1.1);
    % tau_a / tau_m < 1
    \begin{axis}[
      width=0.2\textwidth,
      height=0.15\textwidth,
...
\begin{solution}
  ...
  Let us first tackle the easier of the two problems: shear loading. This is a simple case of a transverse fillet weld (where the shear load is perpendicular to the weld length). The resultant shear stress from shear loading, pointing in the same direction, is
  ...
  Now consider the problem of torsion. The applied torque to the weld is the load multiplied with the distance to the center of the welds $L_o$. In this problem the welds are symmetric, therefore the center is in the middle of the two welds, marked by ...
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    % cylinder
    \node (0,0) [top color=SkyBlue, bottom color=SkyBlue, middle color=SkyBlue!40!White,cylinder, shape border rotate=180,draw, minimum height=7cm, minimum width=2cm]{};
    % element
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[scale=0.8]
    ...
    \draw [SkyBlue!50!Blue, very thick](A.center) --++ (30:8) node(C){} node(F)[above, black,yshift=0.5cm]{$P=0$} node[midway, above, rotate=30]{bolt} -- (B.center) node[midway, above, rotate=-60]{joint};
...
\begin{figure}[h]
  ...
  \end{tikzpicture}
  \caption[Stiffness representation of a bolted joint]{A bolted joint stiffness represented by two springs in parallel. The inner coil represents the bolt stiffness, while the other represents the clamped part stiffness.}
\end{figure}
...
\begin{figure}[h]
  ...
  \label{fig: bolt-joint interaction with external load}
\end{figure}
...
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
    \draw [fill=LightSkyBlue] (0,0) --++ (90:4) --++ (0:5) node(topright){} --++ (-90:0.5) --++ (180:4.5) --++ (-90:3.5) -- cycle;
    \node at (0,2) [anchor=east, pattern=north west lines, minimum height=6cm, minimum width=0.5cm](wall){};
    \draw (wall.north east) -- (wall.south east);
    \node at (wall.east) [xshift=2mm, yshift=1cm, draw, fill=Grey, minimum height=2mm, minimum width=8mm, inner sep=0](top){};
    \node at (wall.east) [xshift=2mm, yshift=-1.5cm, draw, fill=Grey, minimum height=2mm, minimum width=8mm, inner sep=0](bottom){};
    \draw [|<->|] (top.east) ++ (0:0.3) --++ (-90:2.5) node[midway, fill=White]{$h$};
    \draw [<-, ultra thick] (topright.center) --++ (90:1) node[above]{$F$};
    \draw [|<->|] (topright.center) ++ (90:0.5) --++ (180:5) node[midway, fill=White]{$L$};
    \draw [->, ultra thick] (top.east) ++ (0:1) arc (90:-90:1) node[midway, right]{$M = FL$};
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    % \draw [|<->|] (topright.center) ++ (90:0.5) --++ (180:5) node[midway, fill=White]{$L$};
    % \draw [->, ultra thick] (top.east) ++ (0:1) arc (90:-90:1) node[midway, right]{$M = FL$};
    \draw [dashdotted] (wall.west) ++ (-90:0.2) ++ (180:0.5) --++ (0:1.5) node[right]{centroid};
    \draw [->] (top.east) --++ (0:0.5) node[right]{$\sigma$};
    \draw [->] (top.west) --++ (180:0.5);
    \draw [<-] (bottom.east) --++ (0:0.5) node[right]{$\sigma$};
    \draw [<-] (bottom.west) --++ (180:0.5);
  \end{tikzpicture}
  \caption{Bolt resultant stresses from exerted moment.}
  \label{fig: stress in bolted joint under bending}
\end{figure}
...
\begin{align}
  ...
  I &= \sum I_i \\
  I_i &= I_{ci} + A_ir_i^2 %= \frac{\pi}{64}d_i^4 + \frac{\pi}{4}d_i^2 r_i^2
\end{align}
...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}
    \node [draw, fill=LightGrey, minimum height=6cm, minimum width=6cm](A){};
    \node at (A.east) [xshift=-0.0cm, anchor=center, draw, fill=lightblue, minimum height=3cm, minimum width=7cm](B){};
    \draw (B.west) ++ (0:1.5) node(center){+} node[above right]{$O$};
    % force
    \draw [->, ultra thick] (B.east) --++ (-90:2) node[below]{20000 N};
    \foreach \x in {45, 135, 225, 315} {
      \draw (center.center) ++ (\x:1.5) node[draw, fill=Black, circle, minimum height=3mm, inner sep=0]{};
    }
    \draw [|<->|] (center.center) ++ (-90:2) --++ (0:5.5) node[midway, fill=White]{$L_o$};
    \draw [|<->|] (center.center) ++ (-45:0.4) --++ (45:1.5) node[midway, fill=lightblue]{$r_i$};
  \end{tikzpicture}
...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}
    \node [pattern=north west lines, minimum height=5mm, minimum width=2cm](ceil){};
    \draw (ceil.south east) -- (ceil.south west);
    \node at (ceil.south) [anchor=north, draw, fill=Grey, minimum height=3mm, minimum width=1cm](plate){};
    \node at (plate.south) [anchor=north, draw, fill=Grey, minimum height=2cm, minimum width=2mm](shaft){}; 
    \node at (plate.south west) [anchor=south, fill=Black, minimum height=5mm, minimum width=1mm, xshift=1mm, yshift=-1mm, inner sep=0]{};
    \node at (plate.south east) [anchor=south, fill=Black, minimum height=5mm, minimum width=1mm, xshift=-1mm, yshift=-1mm, inner sep=0]{};
    \node at (shaft.south west) [anchor=east, draw, fill=Grey, minimum height=2mm, minimum width=2cm, yshift=1mm, inner sep=0](left){};
    \node at (shaft.south east) [anchor=west, draw, fill=Grey, minimum height=2mm, minimum width=2cm, yshift=1mm, inner sep=0](right){};
  \end{tikzpicture}
\end{figure}
...
\begin{example}
  ...
  \centering
  \begin{tikzpicture}
    \node [rectangle, minimum height=3cm, minimum width=1cm, pattern=north east lines](A){};
...
\item If the spring is welded to the handles with the effective throat thickness $H$ = 5 mm. We may assume that the weld would be on the edge of the handle. The problem did not specify the electrode material and so we will assume that E60 series is used. In this problem the weld is simply butt weld and so the design equation \cref{eqn: MNST design eq} based on MNST and the butt weld stress equation, \cref{eqn: butt weld}, can be written as 
  ...
  Thus the required weld length is \py{'{:.5f}'.format(L)} m.

\item If instead the spring is bolted down to the handle using 2 identical bolts on each side, then each bolt will take half of the maximum \py{F}-N load = \py{round(F/2)} N.
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[>=latex]
      \node [draw, rectangle, fill=SkyBlue, minimum height=1.5cm, minimum width=0.5cm](A){};
      \node [draw, rectangle, fill=white, minimum height=1cm, minimum width=0.3cm]{};
      \node at (A.east) [anchor=west, draw, rectangle, fill=SkyBlue, minimum height=1.5cm, minimum width=2mm, inner sep=0](B){};
      \node at (B.east) [yshift=2mm, xshift=-1mm, draw, rectangle, fill=Black, minimum height=1mm, minimum width=3mm, inner sep=0]{};
      \node at (B.east) [yshift=-2mm, xshift=-1mm, draw, rectangle, fill=Black, minimum height=1mm, minimum width=3mm, inner sep=0]{};
      \draw [decoration={aspect=0.3, segment length=0.1cm, amplitude=0.1cm,coil},decorate, line width=1pt] (B.east) ++ (90:0.2) --++ (0:1) node(C){};
      \draw [decoration={aspect=0.3, segment length=0.1cm, amplitude=0.1cm,coil},decorate, line width=1pt] (B.east) ++ (90:-0.2) --++ (0:1) node(D){};
      \draw [->, ultra thick] (A.west) --++ (180:1) node[left]{700 N};
      \draw [->, ultra thick] (C.center) --++ (0:0.5) node[right]{350 N};
      \draw [->, ultra thick] (D.center) --++ (0:0.5) node[right]{350 N};
    \end{tikzpicture}
    \label{fig: chest exercise bolted handle}
  \end{figure}

  Since the spring is directly pulling along the axis of the bolt, as show in \cref{fig: chest exercise bolted handle}. The external force exerted on the bolted joint will only be an axial tensile load, for which the design equation \cref{eq: total forces on bolted joint} can be written as 
  ...
  \begin{align*}
    A_t &= \frac{N_sP_{shear}}{0.75\mu S_p } + \frac{N_sP_{axial}}{S_p} \\
        &= \frac{ \py{N_s} (0) }{ 0.75 \mu (\pynum{S_p})} + \frac{\py{N_s} ( \py{round(P_axial)} ) }{ \pynum{S_p} } \\
        &= \pynum{A_t} \text{ m}^2
  \end{align*}

 Checking the required tensile stress area against \cref{table: ISO Screw Dimensions}, we find that the area is smaller than the smallest standard bolt M30 $\times$ 0.5. Hence M30 $\times$ 0.5 will be our selection.
...
The critical point is at the rounded surface on the fixed end. The maximum Von Mises stress ($\sigma_e$) is 83 MPa. The yield strength is written on the bottom of the legend at 275 MPa. We can also convert the stress plot to safety factor (or as SolidWorks call it \emph{factor of safety}). The aluminum alloy used within this case is a ductile material, so we use the MDET to determine safety factors.
...
\end{example}
\begin{solution}
  Using the same crank as in the previous example, we understand that buckling
  can only happen under compressive lo, which is when the pedal end of the crank comes all the way up to the top of the rotation. We will assume that the same 1500-N and 11.25 N-m load still apply. It is important to note, however, that the 1500 N is now compressive and the bending moment is in the opposite direction compared to the previous example.

  Applying the condition under `buckling' analysis Solidworksrks, we obtain the following figure.
...
\chapter{Solutions to Selected Exercises} \label{chap: solutions to exercises}
...
\item The main purpose of an engine shaft is to transfer torque. To minimize the weight of a torque-loaded shaft, we use the minimum weight index formula
  ...
  Let us choose the following materials to represent each qualified category:

  \begin{center}
    \begin{tabular}[ht]{lccc}
      \toprule
      Category & Material & $S_{ut}$ [MPa] & $\rho$ [kg/m$^{3}$] \\
      \midrule
      ceramics & silicon carbide (SiC) & 200 & 3200 \\
      titanium alloys & Ti-6Al-4V (Ti) & 900 & 4500 \\
      nickel alloys & Alloy 625 Inconel (Ni) & 690 & 8440 \\
      steel alloys & SAE 945 (St) & 430 & 7800 \\
      \bottomrule
    \end{tabular}
  \end{center}

  We can then determine the minimum weight index for the materials, obtaining
  \begin{align*}
    &M_{\text{SiC}} = \pynum{200e6**0.5/3200} \\
    &M_{\text{Ti}} = \pynum{900e6**0.5/4500} \\
    &M_{\text{Ni}} = \pynum{690e6**0.5/8440} \\
    &M_{\text{St}} = \pynum{430e6**0.5/7800}
  \end{align*}
  The material with the highest index is Ti64, which should give us the lightest shaft.
\end{evensolution}
...
\begin{evensolution}
\item In this condition, since the column is pin-supported at the ends and also in the middle. Therefore, the smallest compressive load that could cause buckling would be corresponding to the 2nd ($n$ = 2) mode shape. In another words,
  ...
  The safety factor for this beam is simply the ratio of the maximum allowable load to the intended load.

  \begin{align*}
    N_s = \frac{4.07 \times 10^7}{7 \times 10^6} = 5.81
  \end{align*}

\item First, determine $t_1$. To do so, we need to determine the longitudinal and circumferential stresses due to the 20 kPa pressure.
...
\item We first need to determine the maximum bending moment and resulting bending stress. In this case, the maximum bending moment happens at the right leg, which is 1 m from the end of the board. Hence,
  ...
  We can express the maximum deflection $\delta$ using the force exerted at the end of the beam $F_{\max}$ using the formula proven in \ref{subsub: energy
    method}.
...
\item First we need to determine the spring constant. The spring energy must be equal to the kinetic energy in the dart.
  ...
  We can then obtain the coil diameter $D$ from $D = Cd$ = \py{8.26*6*10**-4} m. To determine the number of active coils, we use
...
\item In this problem we have two conditions for failure: 1) the board is broken and 2) the welds failed. All we need to do is determine the maximum loads allowed on each component; the smaller of the two is our final answer.
  ...
  This shows that the beam would break before the weld, hence the maximum allowable load is 6250 N.
\end{evensolution}
...
\item We need to determine the load carried by the front and rear wheels and their respective forks.
  ...
  \begin{align*}
    F_f = \frac{5000 \times 0.2}{1.2} = 833 \text{ N} \\
    F_r = \frac{5000 \times 1}{1.2} = 4167 \text{ N}
  \end{align*}
...
\begin{table}[H]
  ...
  \begin{tabular}{cccc}
    \toprule
    Section & Moment of Inertia & Polar Moment of Inertia & Section Modulus \\
    \midrule
    \begin{tikzpicture}[baseline=(current bounding box.center)]
      \node[draw, minimum height=2cm, minimum width=1cm, fill=LightSkyBlue](rect){};
      \draw [|<->|] (rect.south east) ++ (0:0.2) --++ (90:2) node[midway, right]{$h$};
      \draw [|<->|] (rect.south east) ++ (-90:0.2) --++ (180:1) node[midway, below]{$b$};
    \end{tikzpicture}
            & $\dfrac{bh^3}{12}$ & $\dfrac{bh^3}{12} + \dfrac{hb^3}{12}$ & $\dfrac{bh^2}{6}$ \\
    \begin{tikzpicture}[baseline=(current bounding box.center)]
      \node[minimum height=2.5cm]{};
      \node[draw, circle, minimum height=2cm, fill=LightSkyBlue](circ){};
      \draw [->] (circ.center) --++ (60:1) node[midway, below right]{$R$};
    \end{tikzpicture}
            & $\dfrac{\pi R^4}{4}$ & $\dfrac{\pi R^4}{2}$ & $\dfrac{\pi R^3}{4}$ \\
    \begin{tikzpicture}[baseline=(current bounding box.center)]
      \node[draw, regular polygon, regular polygon sides=3, minimum height=2cm, fill=LightSkyBlue](tri){};
      \draw [|<->|] (tri.south east) ++ (0:0.5) --++ (90:1.5) node[midway, right]{$h$};
      \draw [|<->|] (tri.south east) ++ (0:0.4) ++ (-90:0.2) --++ (180:1.8) node[midway, below]{$b$};
    \end{tikzpicture}
            & $\dfrac{bh^3}{36}$ & $\dfrac{\sqrt{3} b^4}{48}$ & $\dfrac{bh^2}{24}$ \\
    \begin{tikzpicture}[baseline=(current bounding box.center)]
      \node[draw, minimum height=2cm, minimum width=1cm, fill=LightSkyBlue](rect){};
      \node[draw, minimum height=1.6cm, minimum width=0.6cm, fill=White](rect1){};
      \draw [|<->|] (rect.south east) ++ (0:0.2) --++ (90:2) node[midway, right]{$h$};
      \draw [|<->|] (rect.south east) ++ (-90:0.2) --++ (180:1) node[midway, below]{$b$};
      \draw [|<->|] (rect1.north west) ++ (180:0.4) --++ (-90:1.6) node[midway, left]{$h_i$};
      \draw [|<->|] (rect1.north west) ++ (90:0.4) --++ (0:0.6) node[midway, above]{$b_i$};
    \end{tikzpicture}
            & $\dfrac{bh^3 - b_ih_i^3}{12}$ & $\dfrac{bh^3 - b_ih_i^3}{12} + \dfrac{hb^3 - h_ib_i^3}{12}$ & $\dfrac{bh^2 - b_ih_i^2}{6}$ \\
    \begin{tikzpicture}[baseline=(current bounding box.center)]
      \node[draw, circle, minimum height=2cm, fill=LightSkyBlue](circ){};
      \node[draw, circle, minimum height=1.6cm, fill=White](circi){};
      \draw [->] (circ.center) --++ (60:1) node[midway, left]{$R$};
      \draw [->] (circ.center) --++ (0:0.8) node[midway, below]{$R_i$};
    \end{tikzpicture}
            & $\dfrac{\pi \left( R^4 - R_i^4 \right)}{4}$ & $\dfrac{\pi \left( R^4 - R_i^4 \right) }{2}$ & $\dfrac{\pi \left(R^3 - R_i^3 \right)}{4}$ \\
    \begin{tikzpicture}[baseline=(current bounding box.center)]
      \node[minimum height=2.5cm]{};
      \node [draw, LightSkyBlue, fill=LightSkyBlue, minimum height=1.2cm, minimum width=3mm, inner sep=0](mid){};
      \node at (mid.north) [draw, LightSkyBlue, anchor=south, fill=LightSkyBlue, minimum height=3mm, minimum width=1.2cm, inner sep=0](top){};
      \node at (mid.south) [draw, LightSkyBlue, anchor=north, fill=LightSkyBlue, minimum height=3mm, minimum width=1.2cm, inner sep=0](bottom){};
      \draw (mid.north east) -- (mid.south east) -- (bottom.north east) -- (bottom.south east) -- (bottom.south west) -- (bottom.north west) -- (mid.south west) -- (mid.north west) -- (top.south west) -- (top.north west) -- (top.north east) -- (top.south east) -- cycle;
      \draw [|<-] (top.south east) ++ (0:0.2) --++ (-90:0.3) node[at start, above right, yshift=-1mm]{$h$};
      \draw [|<-] (top.north east) ++ (0:0.2) --++ (90:0.3);
      \draw [|<-] (mid.north east) ++ (90:0.5) --++ (0:0.3) node[at start, above left, xshift=1mm]{$B$};
      \draw [|<-] (mid.north west) ++ (90:0.5) --++ (180:0.3);
      \draw [|<->|] (mid.north west) ++ (180:0.6) --++ (-90:1.2) node[midway, fill=White]{$H$};
      \draw [|<->|] (bottom.south west) ++ (-90:0.3) --++ (0:1.2) node[midway, fill=White]{$b$};
    \end{tikzpicture}
            & $\dfrac{BH^3}{12} + 2 \left[ \dfrac{bh^3}{12} + bh \dfrac{(H+h)^2}{4} \right]$ & - & $\dfrac{\dfrac{BH^3}{12} + 2 \left[ \dfrac{bh^3}{12} + bh \dfrac{(H+h)^2}{4} \right]}{\dfrac{H}{2}+h}$ \\
    \bottomrule
  \end{tabular}
  \caption{Section properties of various geometric shapes.}
  \label{tab: sec properties of shapes}
\end{table}
...
% LocalWords:  multiaxial Solidworks Sappinandana superalloys thermoset
% LocalWords:  machinability hardenability formability weldability cyaniding
% LocalWords:  unhardenable Castigliano
