...
Properties of some of the commonly used reinforcements are listed in \cref{tab: resin props} and \cref{tab: reinforcement props}.
...
\begin{solution}
  ...
  Note that $\tau_{allow}$ is derived from maximum shear stress theory in which , for which $\tau_{allow} = S_y/2$.
\end{solution}
