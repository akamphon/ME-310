...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot+ [domain=1000:1000000, mark=none, thick] {x^(-1/7.58)*10^(3/7.58)*0.72};
      \addplot+ [Blue, domain=1000000:10000000, mark=none, thick] {0.29};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture} 
    \begin{axis}[
      ...
      \addplot [SkyBlue, ultra thick] {-0.72/0.8*x + 0.72};
      \addplot [SkyBlue, ultra thick] {-0.54/0.8*x + 0.54};
      \addplot [SkyBlue, ultra thick] {-0.395/0.8*x + 0.395};
      \addplot [SkyBlue, ultra thick] {-0.29/0.8*x + 0.29};
    ...
    \end{axis}
    \draw [-latex] (0.1\textwidth,0.4\textwidth) ++ (-0.6,0.4) --++ (-170:1);
    % tau_a / tau_m = 1
    \begin{axis}[
      width=0.2\textwidth,
      height=0.15\textwidth,
