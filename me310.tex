...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \draw [<-, ultra thick] (topright.center) --++ (90:1) node[above]{$P$};
...
The additional resultant support forces the bolt(s) must provide to resist the moment can be calculated similar to those derived in \cref{section: weld joints under torsion and bending} for welded joints, namely to translate the loads to the centroid of the bolts. In the referred figure, we can see that the bending moment from force $P$ is $PL$, and that the centroid of the bolts in the middle between the two bolts. We can then find the response of the bolt to the exerted moment using the following expressions.
...
where $y$ is the bolt distance from the centroid and $I$ is the moment of inertia of the bolts.
