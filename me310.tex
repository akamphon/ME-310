...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \draw (ground.north west) -- (ground.north east);
    \draw [decoration={aspect=0.2, segment length=0.3cm, amplitude=0.4cm,coil},decorate, line width=1pt] (ground.north west) ++ (0:1) --++ (90:2.72) node(B){};
    \draw [decoration={aspect=0.15, segment length=0.2cm, amplitude=0.4cm,coil},decorate, line width=1pt] (ground.north) --++ (90:1.65) node(B){};
    \draw [decoration={aspect=0.1, segment length=0.1cm, amplitude=0.4cm,coil},decorate, line width=1pt] (ground.north east) ++ (180:1) --++ (90:0.75) node(B){};
  \end{tikzpicture}
