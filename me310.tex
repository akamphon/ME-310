...
\begin{solution}
  ...
  The maximum bending moment, according to $M(x)$ is at $x$ = 0.5 where $M$ = $\dfrac{3(2000)(0.5)}{4}$ = \py{round(3*2000*0.5/4)} N-m. Since we have assumed that the material is ductile, we will employ MDET \cref{eqn: design eqn for MDET} and bending stress \cref{eqn: flexure formula} for our design equation, which gives
