...
\item We first need to determine the maximum bending moment and resulting bending stress. In this case, the maximum bending moment happens at the right leg, which is 1 m from the end of the board. Hence,
  ...
  \begin{align*}
    M_{\max} &= 150 \times 10 \times 1 = 1500 \text{ N-m} \\
    \sigma_{b} &= \frac{My}{I} = \frac{1500(h/2)}{(1/12)(0.5)h^3 } \\
             &= \frac{18000}{h^2}
  \end{align*}
  ...
  \begin{align*}
    M(x) &= \left\{
           \begin{array}{ll}
             F_{\max} x & 0 \leqslant x \leqslant \dfrac{L}{2} \\
             F_{\max} (1 - x) & \dfrac{L}{2} \leqslant x \leqslant L
           \end{array}
           \right.
  \end{align*}
  ...
  \begin{align*}
    E_{after} &= \int_0^{\frac{L}{2}} \frac{F_{\max}^2 x^2}{2EI} dx + \int_{\frac{L}{2}}^L \frac{F_{\max}^2(1-x)^2}{2EI} dx
  \end{align*}

  We can express the maximum deflection $\delta$ using the force exerted at the end of the beam $F_{\max}$
