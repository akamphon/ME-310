...
\chapter*{บันทึกแก้ไข}
\label{sec:org81f51c2}
\begin{itemize}
\item July 2014
\label{sec:org24ba41a}

Initial complete contents of Chapters 1 - 7.

\item March 2015
\label{sec:org834c33a}

Added Chapter 8.

\item August 2015
\label{sec:orga2e67b7}

Added Chapter 9.

\item April 2016
\label{sec:orgbc08765}

Added Exercises in Chapters 1 - 2.

\item September 2016
\label{sec:org3265b97}

Added Chapters 10 and 11. Added exercises in Chapters 6 - 11.

\item February 2017
\label{sec:org1a480d8}
...
\label{sec:org9319c07}
\chapter{การออกแบบทางวิศวกรรมเบื้องต้น}
\label{sec:orgf60a9b3}
...
(MPa) \&
\$$\backslash$\dfrac{\\sigma _a}\{($\backslash$\(\sigma_{\text{a}}\))\(_{\text{allow}}\)\} + $\backslash$\dfrac{\\sigma_b}\{($\backslash$\(\sigma_{\text{b}}\))\(_{\text{allow}}\)\}\$\\
...
rate using [[\#eqn: spring constant]\ref{eq:orgcc2af92}].
...
[[\#fig: spring design flowchart]\ref{orgf8bf17b}]
...
\label{sec:org3bd0364}
\chapter{Welded Joint Design}
\label{sec:orgf1c4dc4}
...
\label{sec:org8775520}
\begin{center}
\label{tab:orgfd37400}
